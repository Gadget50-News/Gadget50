...
if (!defined('DB_HOST') || !defined('DB_NAME') || !defined('DB_USER') || !defined('DB_PASS') || !defined('APP_NAME')) { http_response_code(500); exit('Application configuration is incomplete.'); }
