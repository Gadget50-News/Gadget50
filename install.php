...
PHP;
            ...
            if (file_put_contents(__DIR__ . '/config.php', $configContent) === false) {
                throw new RuntimeException('config.php could not be written. Check file permissions.');
            }
...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #eff6ff, #f8fafc); }
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="post" autocomplete="off">
                            ...
                            <div class="mt-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <small class="text-muted">This creates required tables and inserts default values before locking the installer.</small>
