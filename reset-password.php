...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($token === '' || strlen($password) < 8 || $password !== $confirm) {
        setFlash('danger', 'Please provide a valid reset token and matching password.');
    ...
    if (!$user) {
        setFlash('danger', 'This reset link is invalid or expired.');
        redirect('forgot-password.php');
    }
...
<head>
    ...
    <title>Reset Password | Gadget 50</title>
